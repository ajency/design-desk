...
<form id="order_review" method="post">
	...
	<div id="payment">
		...
		<h4 id="payment-method" class="hb-heading hb-center-heading"><span><?php _e('Payment', 'woocommerce'); ?></span></h4>
		...
		<div class="form-row">
			...
			<?php
				...
				echo apply_filters( 'woocommerce_pay_order_button_html', '<input type="submit" class="checkout-button button alt" id="place_order" value="' . esc_attr( $pay_order_button_text ) . '" data-value="' . esc_attr( $pay_order_button_text ) . '" />' );
			?>			
