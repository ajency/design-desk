...
<div class="hb-accordion-single">
			<div class="hb-accordion-tab"><i class="hb-moon-truck"></i><?php _e( 'Calculate Shipping', 'woocommerce' ); ?><i class="fa fa-angle-right"></i></div>
			<div class="hb-accordion-pane">
				<form class="shipping_calculator-hb" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
