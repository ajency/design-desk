...
class hb_flickr_widget extends WP_Widget {
	...
	function HB_Flickr_Widget() {
		...
		$control_ops = array ();
		/* Create the widget. */
		$this->WP_Widget( 'hb_flickr_widget', __('[HB-Themes] Flickr Grid','hbthemes'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- Username: Text Input -->
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php echo 'Flickr Username ID: '; ?></label>
