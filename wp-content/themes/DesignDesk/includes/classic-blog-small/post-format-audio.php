...
?>
<!-- BEGIN .hentry -->
<article id="post-<?php the_ID(); ?>" <?php if( $mp3_link && $ogg_link ) post_class('audio-post-format self-hosted-audio'); else if ( $soundcloud_link ) post_class('with-featured-image audio-post-format'); else post_class('audio-post-format');?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
