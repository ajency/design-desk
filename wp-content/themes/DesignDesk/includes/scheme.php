...
/* SCHEME STYLES
 ...
 if (!function_exists('hb_scheme_styles')) { 
	function hb_scheme_styles() {
		...
		.hb-side-nav li a:hover, .hb-side-nav li.current-menu-item > a, .hb-side-nav li.current-menu-ancestor > a { color: '.$focus_hex_color.'!important; }
		...
		#main-wrapper input.checkout-button, .side-nav-bottom-part ul li a:hover { background-color:'.$focus_hex_color.'; }
		...
		if ( hb_options('hb_color_manager_type') == 'hb_color_manager_color_customizer' ){
			...
			if (get_theme_mod('hb_side_nav_bg_setting')){
				echo '#hb-side-navigation.hb-non-transparent, #hb-side-navigation .hb-resp-bg { background-color: '.get_theme_mod('hb_side_nav_bg_setting').'; }';
			}
			...
			if (get_theme_mod('hb_nav_bar_text_setting')){
				echo '#main-wrapper #main-nav > li > a, #main-wrapper #header-inner-bg { color:'.get_theme_mod('hb_nav_bar_text_setting').'; }';
				echo 'body:not(.page-template-page-presentation-fullwidth) #main-wrapper #main-nav > li > a, #main-wrapper #header-inner-bg { color:'.get_theme_mod('hb_nav_bar_text_setting').' !important; }';
			...
			if (get_theme_mod('hb_footer_bg_setting')){
				echo '#footer, body #lang_sel_footer { background-color: '.get_theme_mod('hb_footer_bg_setting').'; }';
			}
			...
			if (get_theme_mod('hb_footer_link_setting')){
				echo '#main-wrapper #footer a, body #lang_sel_footer a { color: '.get_theme_mod('hb_footer_link_setting').'; }';
			}
			...
			if (get_theme_mod('hb_side_section_bg_setting')){
				echo '#hb-side-section {background-color: '.get_theme_mod('hb_side_section_bg_setting').';}';
			}
