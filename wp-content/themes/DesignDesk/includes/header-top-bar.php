...
<div id="header-bar" class="style-1 clearfix">
    ...
    <div id="top-map-widget" class="top-widget float-left">
        <a href="#" id="show-map-button"><i class="fa fa-map-marker"></i><?php echo hb_options('hb_top_header_map_text'); ?></a>
    </div>
    <!-- END .top-widget -->
    <?php } 
    ...
    ?>
        ...
        <div class="top-widget float-left clear-r-margin">
            <a href="mailto:<?php echo $header_left_email; ?>"><i class="fa fa-envelope-o"></i><?php echo $header_left_email; ?></a>
        </div>
        <!-- END .top-widget -->
    <?php } 
    ...
    <div id="top-login-widget" class="top-widget float-right clear-r-margin">
        ...
        ?>
                ...
                <div class="hb-dropdown-box login-dropdown">
                    ...
                    <div class="big-overlay"><i class="fa fa-user"></i></div>
                </div>
                <!-- END .login-dropdown-->
        <?php 
            } else { 
        ...
        ?>
                <a href="<?php echo $admin_link_url; ?>"><i class="fa fa-user"></i><?php echo $current_user->display_name; ?><i class="fa fa-angle-down"></i></a>
                ...
                <div class="hb-dropdown-box logout-dropdown">
                    <ul>
                        ...
                        <li>
                            <a href="<?php echo $admin_link_url; ?>" class="my-account"><i class="fa fa-user"></i><?php _e('My Account','hbthemes'); ?></a>
                        </li>
                        <?php } else { ?>
                        <li>
                            <a href="<?php echo admin_url(); ?>"><i class="fa fa-cog"></i><?php _e('Dashboard', 'hbthemes'); ?></a>
                        </li>
                        <?php } ?>

                        <?php if ( class_exists('Woocommerce') ) { ?>
                        <li>
                            <a href="<?php echo $cart_url; ?>" class="cart-contents"><i class="fa fa-cart"></i><?php _e('My Cart','hbthemes'); ?></a>
                        </li>
                        <?php } ?>
                        <li>
                            <a href="<?php echo wp_logout_url( get_permalink() ); ?>"><i class="fa fa-arrow-right"></i><?php _e('Log Out', 'hbthemes'); ?></a>
                        </li>
                    </ul>
                </div>
        <?php } ?>
    ...
    ?> 
        ...
        <div class="top-widget float-right">
            <a href="#" id="hb-current-lang"><span class="active-lang-img"></span><span class="lang-val"><?php _e('Language', 'hbthemes'); ?></span><i class="fa fa-angle-down"></i></a>
            ...
            <?php
                ...
                if ( !empty ( $hb_socials ) ) {
                    ...
                    <?php if ($hb_social_n != 'behance' && $hb_social_n != 'vk' && $hb_social_n != 'envelop') { ?>
                            <li>
                                <a href="<?php echo hb_options('hb_' . $hb_social . '_link'); ?>" original-title="<?php echo ucfirst($hb_social); ?>"<?php echo $target; ?>><i class="fa fa-<?php echo $hb_social_n; ?>"></i></a> 
                            </li>
                        <?php
                        } else if ($hb_social_n == 'envelop') { ?>
                            <li>
                                <a href="mailto:<?php echo hb_options('hb_' . $hb_social . '_link'); ?>" original-title="<?php echo ucfirst($hb_social); ?>"<?php echo $target; ?>><i class="fa fa-<?php echo $hb_social_n; ?>"></i></a> 
                            </li>
                        <?php } else { ?>
                            <li>
                                <a href="<?php echo hb_options('hb_' . $hb_social . '_link'); ?>" original-title="<?php echo ucfirst($hb_social); ?>"<?php echo $target; ?>><i class="fa fa-<?php echo $hb_social_n; ?>"></i></a> 
...
<div id="header-dropdown">
    ...
    <div class="close-map"><i class="fa fa-times"></i></div>
</div>