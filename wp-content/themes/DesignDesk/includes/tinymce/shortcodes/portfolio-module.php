...
var FWPortfolioDialog = {
	local_ed : 'ed',
	init : function(ed) {
		FWPortfolioDialog.local_ed = ed;
...
tinyMCEPopup.onInit.add(FWPortfolioDialog.init, FWPortfolioDialog);
</script>
<form action="/" method="get" accept-charset="utf-8">

        <div class="form-section clearfix">
            <label for="columns">Columns.<br/><small>Choose how many in how many columns to show your portfolio items.</small></label>
        ...
        <div class="form-section clearfix">
            <label for="total-count">Total Items.<br/><small>Choose how many portfolio items to show in the module. To get all items enter -1.</small></label>
        ...
        <div class="form-section clearfix">
            <label for="orientation">Image Orientation.<br/><small>Choose orientation of the portfolio thumbnails.</small></label>
        ...
        <div class="form-section clearfix">
            <label for="ratio">Image Ratio.<br/><small>Choose ratio of the portfolio thumbnails.</small></label>
    ...
    <a href="javascript:FWPortfolioDialog.insert(FWPortfolioDialog.local_ed)" id="insert" style="display: block;">Insert</a>
</form>