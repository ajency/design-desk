				...
				<article id="post-<?php the_ID(); ?>" <?php post_class( get_post_format() . '-post-format single' ); ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
					...
					<div class="single-post-content">
						...
						<div class="post-header">
							...
							<div class="post-meta-info">
								<span class="blog-author minor-meta">
									...
									<span class="post-date date updated"><?php echo get_the_time('M j, Y'); ?></span>
									<?php } ?>
						...
						<div class="entry-content clearfix" itemprop="text">
							<?php the_content(); ?>
							<div class="page-links"><?php wp_link_pages(array('next_or_number'=>'next', 'previouspagelink' => ' <i class="fa fa-angle-left"></i> ', 'nextpagelink'=>' <i class="fa fa-angle-right"></i>')); ?></div>
						</div>
						<!-- END .entry-content -->
						<?php } ?>
