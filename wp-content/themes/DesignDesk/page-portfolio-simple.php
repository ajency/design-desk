				...
				<div class="standard-gallery-filter col-12 clearfix">
					...
					<?php if ( $portfolio_filter ) { 
						...
						<ul class="filter-tabs filt-tabs clearfix">
							<li class="selected"><a href="#" title="<?php _e('View all items','hbthemes'); ?>" class="all" data-filter="*"><span class="item-name"><?php _e('All','hbthemes'); ?></span><span class="item-count">0</span></a></li>
					...
					<!-- BEGIN .sort-tabs -->
					<ul class="filter-tabs sort-tabs clearfix" title="<?php _e('Sort By','hbthemes'); ?>">
						<li class="selected"><a href="#" class="all" data-sort="date"><span class="item-name"><?php _e('Date','hbthemes'); ?></span></a></li>
						<li><a href="#" data-sort="name"><span class="item-name"><?php _e('Name','hbthemes'); ?></span></a></li>
					</ul>
					<!-- END .sort-tabs -->
					<?php } ?>
				...
				?>
					...
					<div class="col-<?php echo 12/$portfolio_columns_count; ?> standard-gallery-item-wrap <?php echo $filters_string; ?>">
						...
						<div class="standard-gallery-item">
							...
							<div class="hb-gal-standard-description portfolio-description" data-value="<?php the_time('c'); ?>">
								...
								<div class="portfolio-small-meta clearfix">
									...
									<a href="<?php echo $perma; ?>" class="float-right details-link"><?php _e('Details <i class="fa fa-angle-right"></i>' , 'hbthemes'); ?></a>
								</div>
