jQuery(document).ready(function () {
	function hide_all_page_meta_boxes() {
		if ( jQuery('.post-type-page').length ) {
			...
			jQuery('#presentation_settings_metabox').hide();
		}
	}
	...
	function show_page_meta_boxes() {
		...
		switch( current ){
			case 'page-contact.php':
				jQuery('#postdivrich, #featured_section_metabox, #general_settings_metabox, #background_settings_metabox').show();
			...
			case 'page-portfolio-simple.php':
				...
				jQuery('#portfolio_standard_page_settings_metabox').show();
			break;
			case 'page-presentation-fullwidth.php':
				jQuery('#presentation_settings_metabox').show();
				jQuery('#postdivrich, #featured_section_metabox, #general_settings_metabox, #background_settings_metabox').hide();
			break;
		}
