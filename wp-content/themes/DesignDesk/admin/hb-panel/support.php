...
<div class="wrap about-wrap hb-about-wrap hb-alt-wrap">
	<div class="hb-badge"></div>
  	<h2><?php echo __("Theme Support","hbthemes"); ?></h1>
...
<div id="changelog" class="hb-tabs">
    	...
    	<p class="about-description"><a href="http://hb-themes.com/home/changelog/highend/" target="_blank" class="button button-hero button-primary">View Changelog</a></p>
</div>
...
<div id="hire-hb" class="hb-tabs">
    	...
    	<p class="about-description"><a href="http://hb-themes.com/home/hire-us/" target="_blank" class="button button-hero button-primary">Get a Quote</a></p>
</div>
