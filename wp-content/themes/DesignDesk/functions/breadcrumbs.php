...
function hbthemes_breadcrumbs() {
  ...
  $delimiter = '<span class="sep-icon"><i class="fa fa-angle-right"></i></span>';
  $before = '<span>';
  $after = '</span>';
	...
	?>
      ...
      if ( class_exists('bbPress') && bbp_is_forum_archive() ) {
       ...
       // echo get_category_parents($cat, TRUE, ' ' . $delimiter . ' ');
  	  ...
  	  echo $before ;
  	  printf( __( 'Tag <span class="sep-icon"><i class="fa fa-angle-right"></i></span> %s', 'hbthemes' ), single_tag_title( '', false ) );
  	  echo  $after;
        ...
        echo $before ;
  	  printf( __( 'Author <span class="sep-icon"><i class="fa fa-angle-right"></i></span> %s', 'hbthemes' ),  $userdata->display_name );
  	  echo  $after;
