							...
							if ( $sidebar_layout == 'wpsidebar' ) {
								...
								<div data-initialindex="-1" id="hb-toggle-<?php echo $unique_id; ?>" class="hb-toggle">
									...
									<div class="hb-accordion-single">
										<div class="hb-accordion-tab"><i class="hb-moon-plus-circle"></i><?php echo $detail['hb_meta_sidebar_detail']; ?><i class="fa fa-angle-right"></i></div>
								...
								foreach ($social_links as $soc_id => $soc_name) {
									...
									?>
										...
										<?php } else { ?>
											<li class="<?php echo $soc_id; ?>"><a href="<?php echo vp_metabox('team_member_settings.hb_employee_social_' . $soc_id); ?>" target="_blank"><i class="fa fa-<?php echo $soc_id; ?>"></i><i class="fa fa-<?php echo $soc_id; ?>"></i></a></li>
										<?php } ?>
									<?php
									}
